...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    $db->update_personal_info($_GET["id"], $_POST["firstname"], $_POST["lastname"], $_POST["dob"], $_POST["nationality"]);
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 pr-md-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="ex: Filipino" name="nationality">
                                        </div>
                                    </div>
                                </div>
